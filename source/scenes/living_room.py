...
class LivingRoom:
    ...
    def __init__(self, screen: py.Surface, system: System):
        ...
        self.background_day = load_img(
            os.path.join("assets", "backgrounds", "living-room_day.png"),
            scale=(1920, 1080),
        )
        self.background_evening = load_img(
            os.path.join("assets", "backgrounds", "living-room_evening.png"),
            scale=(1920, 1080),
        )
        self.background_night = load_img(
            os.path.join("assets", "backgrounds", "living-room_night.png"),
            scale=(1920, 1080),
        )
    ...
    def manage_event(self, event):
        ...
        Args:
            event (pygame.event.Event): pygame 이벤트 객체.
        """
